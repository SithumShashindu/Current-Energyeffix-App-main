...
class MyDrawer extends StatelessWidget {
  ...
  const MyDrawer(
      {required this.userName, required this.userId, required this.points});
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.only(
              topRight: Radius.circular(
                  drawerWidth * 0.2)), // Adjust the radius accordingly
        ),
        child: Column(
            ...
            GestureDetector(
              ...
              child: CircleAvatar(
                ...
                backgroundImage: AssetImage(
                    'assets/images/man.png'), // Replace with user profile picture
              ),
            ),
            SizedBox(height: 10),
            Text(
    ...
    return Builder(
      builder: (BuildContext context) {
        final double drawerWidth =
            MediaQuery.of(context).size.width * 0.6; // 60% of device width
        final double buttonWidth =
            drawerWidth - 50; // Adjusted width for the button
